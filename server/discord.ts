    ...
    client.guilds.cache.forEach((guild) => {
        guild.channels.cache.forEach((channel) => {
            ...
            if (guild.name === 'BOT_DEV_SERVER' && channel.name === 'logs') {
                // channel.send('TASER Bot Is Live!! Awaiting Instructions...');
            }
        });
    });
...
client.on('message', (receivedMessage) => {
    if (receivedMessage.guild != null) {
        ...
        if (receivedMessage.content === '!help') {
            ...
            receivedMessage.content.includes('!bug') &&
            ...
            receivedMessage.content.includes('!request') &&
            (receivedMessage.channel.name === 'taser-bug-reporting' ||
                receivedMessage.channel.name === 'bot-testing-development')
        ) {
            ...
            receivedMessage.content.includes('!approve') &&
            (receivedMessage.channel.name === 'taser-bug-reporting' ||
                receivedMessage.channel.name === 'bot-testing-development')
        ) {
            receivedMessage.delete({ timeout: 1000 });
            ...
            receivedMessage.content.includes('!del') &&
            (receivedMessage.channel.name === 'taser-bug-reporting' ||
                receivedMessage.channel.name === 'bot-testing-development')
        ) {
            receivedMessage.delete({ timeout: 1000 });
            ...
            receivedMessage.content.includes('!optin') &&
            (receivedMessage.channel.name === 'taser-bug-reporting' ||
                receivedMessage.channel.name === 'bot-testing-development')
        ) {
            ...
            receivedMessage.content.includes('!optout') &&
            (receivedMessage.channel.name === 'taser-bug-reporting' ||
                receivedMessage.channel.name === 'bot-testing-development')
        ) {
            if (receivedMessage.channel.name === 'taser-bug-reporting') {
            ...
            receivedMessage.content === '!version' &&
            (receivedMessage.channel.name === 'taser-bug-reporting' ||
                receivedMessage.channel.name === 'bot-testing-development')
        ) {
            ...
            receivedMessage.content.includes('!updateVersion') &&
            (receivedMessage.channel.name === 'taser-bug-reporting' ||
                receivedMessage.channel.name === 'bot-testing-development')
        ) {
            receivedMessage.delete({ timeout: 1000 });
            ...
            receivedMessage.content.includes('!edit') &&
            (receivedMessage.channel.name === 'taser-bug-reporting' ||
                receivedMessage.channel.name === 'bot-testing-development')
        ) {
            receivedMessage.delete({ timeout: 1000 });
